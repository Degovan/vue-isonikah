            ...
            <div class="footer-body">
                <div class="flex-footer">
                    <div class="col-footer">
                        ...
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto sint quibusdam officia ut necessitatibus aperiam eveniet, quasi sapiente temporibus cupiditate?</p>
                    </div>
                     <div class="col-footer">
                     ...
                     <div class="col-footer">
                      <div class="menu-footer">
                        ...
                        <router-link to="">Kebijakan & Privasi</router-link>
