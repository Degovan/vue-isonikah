      ...
      <div class="container">
        ...
        <div class="wrapper-card">
          ...
          <div class="card">
            ...
            <!-- bagian content card -->
            <div class="content-card">
              <h1>Makeup Karnaval Rosemary</h1>
              <h2>Rp 2.500.000</h2>
              <p>Makeup</p>
            </div>
            <br /><br />
